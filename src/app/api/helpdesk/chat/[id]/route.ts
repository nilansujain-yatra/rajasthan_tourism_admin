...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${getBaseUrl()}/helpdesk/getChat/${encodeURIComponent(id)}`, {
      method: 'GET',
      headers: {
    ...
    const message = error instanceof Error ? error.message : 'Unable to fetch helpdesk chat.'
