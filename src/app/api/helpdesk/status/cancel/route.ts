...
export async function PUT(request: Request) {
  ...
  try {
    ...
    const response = await fetch(`${getBaseUrl()}/helpdesk/cancel-help-ticket?id=${encodeURIComponent(id)}`, {
      method: 'PUT',
      headers: {
    ...
    const message = error instanceof Error ? error.message : 'Unable to cancel helpdesk ticket.'
