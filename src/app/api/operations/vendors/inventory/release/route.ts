...
export async function GET(request: NextRequest) {
  try {
    const url = new URL(`${getBaseUrl()}/vendor/place/release/requests`)
    ...
    const message = error instanceof Error ? error.message : 'Unable to fetch release inventory requests.'
