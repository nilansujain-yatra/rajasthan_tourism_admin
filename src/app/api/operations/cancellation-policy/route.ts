...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (policyId) {
      const url = new URL(`${getBaseUrl()}/cancel-policy/${encodeURIComponent(policyId)}`)
    ...
    const url = new URL(`${getBaseUrl()}/cancel-policy`)
    ...
    const message = error instanceof Error ? error.message : 'Unable to fetch cancellation policies.'
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Unable to create cancellation policy.'
    return NextResponse.json({ message }, { status: 500 })
  }
}
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Unable to update cancellation policy.'
    return NextResponse.json({ message }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Unable to delete cancellation policy.'
    return NextResponse.json({ message }, { status: 500 })
  }
}
