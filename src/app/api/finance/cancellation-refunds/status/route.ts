...
export async function POST(request: Request) {
  ...
  try {
    ...
    const response = await fetch(`${getBaseUrl()}/booking/refund/status/update`, {
      method: 'POST',
      headers: {
    ...
    const message = error instanceof Error ? error.message : 'Unable to update cancellation refund status.'
